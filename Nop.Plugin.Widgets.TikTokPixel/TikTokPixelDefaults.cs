...
public class TikTokPixelDefaults
{
    /// <summary>
    /// Gets the plugin system name
    /// </summary>
    public static string SystemName => "Widgets.TikTokPixel";

    /// <summary>
    /// Gets the configuration route name
    /// </summary>
    public static string ConfigurationRouteName => "Plugin.Widgets.TikTokPixel.Configure";

    /// <summary>
    /// Gets the generic attribute name to hide search block on the plugin configuration page
    /// </summary>
    public static string HideSearchBlockAttribute => "TikTokPixel.HideSearchBlock";
    ...
    /// </summary>
    public static string PrefixCacheKey => "Nop.Plugin.Widgets.TikTokPixel";
    ...
    /// </remarks>
    public static CacheKey ConfigurationCacheKey => new("Nop.Plugin.Widgets.TikTokPixel.Configuration-{0}", PrefixCacheKey);
    ...
    /// {0} : store identifier
    /// </remarks>
    public static CacheKey ConfigurationsCacheKey => new("Nop.Plugin.Widgets.TikTokPixel.Configurations-{0}", PrefixCacheKey);

    /// <summary>
    /// Gets the cache key for custom events
    /// </summary>
    public static CacheKey CustomEventsCacheKey => new("Nop.Plugin.Widgets.TikTokPixel.CustomEvents-{0}", PrefixCacheKey);

    /// <summary>
    /// Gets the cache key for widget zones
    /// </summary>
    public static CacheKey WidgetZonesCacheKey => new("Nop.Plugin.Widgets.TikTokPixel.WidgetZones", PrefixCacheKey);
    ...
    /// </summary>
    public const string PURCHASE = "PlaceAnOrder";
    ...
    /// </summary>
    public static string TrackedEventsSessionValue => "TikTokPixelTrackedEvents";
    ...
    /// <summary>
    /// Gets the name of TikTok conversions api base address to send tracked events
    /// </summary>
    public static string ConversionsApiBaseAddress = "https://business-api.tiktok.com/open_api/v1.3/";

    /// <summary>
    /// Gets the name of TikTok conversions api event endpoint to send tracked events
    /// </summary>
    public static string ConversionsApiEventEndpoint = "event/track/";
